...
$subtitulo       = !empty($grupo_noticias['subtitulo']) ? esc_html($grupo_noticias['subtitulo']) : '';
$titulo          = !empty($grupo_noticias['titulo']) ? esc_html($grupo_noticias['titulo']) : '';
$cta             = !empty($grupo_noticias['cta']) ? $grupo_noticias['cta'] : [];
$cta_text        = !empty($cta['title']) ? esc_html($cta['title']) : '';
$cta_url         = !empty($cta['url']) ? esc_url($cta['url']) : '';
$cta_target      = !empty($cta['target']) ? esc_attr($cta['target']) : '';
?>

<section class="seccionNoticias position-relative overflow-hidden py-lg-72 py-42 px-lg-60">
