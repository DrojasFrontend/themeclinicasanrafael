...
$items                  = !empty($grupo_texto_cta_imagen['items']) ? $grupo_texto_cta_imagen['items'] : '';
...
?>
<section class="historiaSeccionTextoCTAImagen bg-white">
  <div class="py-lg-72 py-60">
    <div class="container">
      <div class="row flex-lg-row flex-column-reverse">
        <div class="col-lg-6 pt-lg-72 pt-0">
          ...
          <?php if ($descripcion) { ?>
            <p class="p mb-lg-24 mb-42">
              <?php echo $descripcion; ?>
            </p>
          <?php } ?>

          <?php if ($items) { ?>
            <div class="mb-lg-24 mb-30">
              <?php echo $items; ?>
            </div>
          <?php } ?>
