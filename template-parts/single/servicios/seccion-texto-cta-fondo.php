...
$posicion              = !empty($grupo_texto_cta_fondo['posicion']) ? esc_html($grupo_texto_cta_fondo['posicion']) : '';
...
<section class="seccionTextoCTAFondo" style="order: <?php echo $posicion; ?>; background-image: url(<?php echo $fondo; ?>); background-repeat: no-repeat; background-size: cover">
